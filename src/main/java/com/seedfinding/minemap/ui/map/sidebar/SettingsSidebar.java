...
import com.seedfinding.minemap.ui.component.BiomeEntry;
import com.seedfinding.minemap.ui.component.FeatureEntry;
...
public class SettingsSidebar extends JPanel {
    ...
    private void addGlobalToggles() {
        ...
        JCheckBox showFlowers = new JCheckBox("Show Flowers") {
            @Override
            protected void paintComponent(Graphics g) {
                this.setSelected(SettingsSidebar.this.settings.showFlowers);
                super.paintComponent(g);
            }
        };
        ...
        showFlowers.addItemListener(e -> {
            this.settings.showFlowers = showFlowers.isSelected();
            this.map.repaint();
        });
